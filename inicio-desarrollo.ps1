...
Write-Host " Paso 3: Esperando a que los servicios estén listos..." -ForegroundColor Yellow
...
if (-not $allReady) {
    Write-Host "  Timeout: Los servicios tardaron más de lo esperado" -ForegroundColor Red
...
Write-Host "   4. La API se activará en http://localhost:8000" -ForegroundColor White
Write-Host ""
Write-Host " SERVICIOS DISPONIBLES:" -ForegroundColor Cyan
Write-Host "    Frontend:     http://localhost:3000" -ForegroundColor White
Write-Host "    Backend API:  http://localhost:8000 (después de F5)" -ForegroundColor White

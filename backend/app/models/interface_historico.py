from sqlalchemy import Column, Integer, BigInteger, DateTime, DECIMAL, TIMESTAMP, ForeignKey, Index
...
class InterfaceHistorico(Base):
    ...
    devif = Column(Integer, ForeignKey('monitoreo.interfaces.devif', ondelete='CASCADE'), nullable=False)

from sqlalchemy import Column, Integer, String, BigInteger, DateTime, DECIMAL, TIMESTAMP, ForeignKey, UniqueConstraint
...
class Interfaces(Base):
    ...
    devid = Column(Integer, ForeignKey('monitoreo.dispositivos.devid', ondelete='CASCADE'), nullable=False, index=True)
    ...
    historico = relationship("InterfaceHistorico", back_populates="interface", cascade="all, delete-orphan")
